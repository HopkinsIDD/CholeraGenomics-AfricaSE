...
new_seq <- read_xlsx("./supp_data/supplementary_appendix_2.xlsx") %>% filter(meeting_criteria)
...
annotation_raw <- read_xlsx("./supp_data/supplementary_appendix_3.xlsx")
...
### Supp Figure 2: Maximum likelihood tree of 1488 V. cholerae genomes. Colored by country

```{r supp fig2, echo=F, message=F, warning=F, fig.height=8, fig.width=12, background="white"}


##supplemental fig3A
supp_fig2 <- ggtree(tree_1488,
                      layout="circular",
                      size=0.5
                      ) %<+% anno_withnode +
  geom_treescale(x=0.003,
