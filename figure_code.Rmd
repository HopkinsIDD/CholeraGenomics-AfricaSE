...
T13_tMRCA <- read_xlsx("./supp_data/supplementary_appendix_9.xlsx") %>%
...
vc_1488_rtt <- 
  read_xlsx("./supp_data/supplementary_appendix_8.xlsx",
             sheet = "full_tree")
...
vc_wave3_rtt <- read_xlsx("./supp_data/supplementary_appendix_8.xlsx",
                         sheet="wave3_tree")
